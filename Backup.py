...
class SoundDictonary():
    ...
    def frame(self):
        self.root = Tk(className=" Min Editor")
        # Menu options
        ...
        self.menu.add_cascade(label="Sound for your contents", command=self.speak)
        self.menu.add_cascade(label="About", command=self.about)
